        ...
        <Card className="shadow-xl text-center">
          ...
          <CardContent className="space-y-4">
            ...
            <Button
              ...
              disabled={resending}
              onClick={() => {
                /* TODO: implement resend via backend */
              }}
            >
              {resending ? (
                <>
...
export default function RegisterPage() {
  ...
  // Show email confirmation screen after successful signup without session
  if (confirmedEmail) {
  ...
  const onSubmit = (values: RegisterFormValues) => {
    registerMutation.mutate(values, {
      onSuccess: (result) => {
        ...
        // If message mentions email confirmation, show the confirmation screen
        if (
          ...
          // Registration successful without email confirmation required
